...
# [printer]
# kinematics: limited_corexy;
# max_x_accel: 40000 ;[empirically determined, max_accel taken if omitted]
# max_y_accel: 15800 ;[empirically determined, less than max_x_accel because of gantry mass]
